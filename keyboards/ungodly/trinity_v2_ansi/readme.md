# Trinity V2 - ANSI Variant

A semi-assembled hotswap PCB for the Rama U-80 that offers multiple layout options.

![Trinity Front](https://i.imgur.com/FVzfZJ7.jpg)
![Trinity Back](https://i.imgur.com/yE5VAWt.jpg)
![Trinity Layouts](https://i.imgur.com/5svW76M.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make ungodly/trinity_v2_ansi:default

Flashing example for this keyboard:

    make ungodly/trinity_v2_ansi:default:flash
